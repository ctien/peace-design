    ...
    <div className={cn(['w-full transition-all z-30 lg:py-4 py-2'])}>
      <Container className="flex items-center justify-between">
        ...
        <div>
          ...
          <button className="inline-block px-4 py-3 text-xs font-semibold leading-none bg-indigo-50 hover:bg-indigo-100 text-blue-600 rounded-4xl transition duration-100 rounded-full">
            Contact Us
          </button>
        </div>
      </Container>
